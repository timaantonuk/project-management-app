...
function Sidebar({projectsArr, onActiveProjectClick, activeProjectId, addTask}) {
  ...
  return (
      <aside className='rounded-xl lg:rounded-r-none bg-stone-800 py-16 px-8 flex flex-col gap-8 text-white lg:w-1/3'>
        ...
        <button className='bg-stone-500 text-white font-outfit font-light rounded-xl py-3 flex items-center justify-center gap-2 hover:bg-stone-700 transition-all duration-300'> Add Project <MdNoteAlt style={{width:'25px', height:'25px'}} className='text-stone-800'/></button>
