...
function NoProjects({handleAddProjectClick}) {
  return (
      <div className='bg-white opacity-[92%] flex flex-col items-center justify-center border-stone-800 border-4 w-full px-4 py-12 gap-5 rounded-xl lg:rounded-l-none'>
