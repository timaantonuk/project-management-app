...
function NoProjects() {
  return (
      <div className='flex flex-col items-center justify-center border-stone-800 border-4 w-full px-4 py-12 gap-5 rounded-xl lg:rounded-l-none'>
        ...
        <button className='text-white bg-stone-800 px-6 lg:px-10 transition-all duration-300-2 rounded-xl hover:bg-stone-600 py-4 lg:py-3'>Create New Project</button>
      </div>
  );
}
