      ...
      <div className='flex flex-col border-stone-800 border-4 w-full px-4 py-12 gap-5 rounded-xl lg:rounded-l-none'>
        ...
        <div className='flex gap-7 flex-col lg:flex-row'>
          <input type="text"
                 ...
                 className="py-3 lg:py-2 bg-stone-300 lg:w-1/2 rounded-xl px-4 outline-none focus:border-stone-800 focus:border-b-2 active:border-stone-800 active:border-b-2 transition-all duration-300" placeholder='Your Task...'/>
